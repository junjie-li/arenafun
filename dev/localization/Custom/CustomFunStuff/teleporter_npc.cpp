...
public:
...

    {
        ...
        {
            pPlayer->GetSession()->SendAreaTriggerMessage("你正在战斗中");
            return false;
        }
        ...
        if (!pPlayer->IsAlive())
        {
            pPlayer->GetSession()->SendAreaTriggerMessage("你已经死亡");
            return false;
        }
        ...
        if (pPlayer->InArena())
        {
            pPlayer->GetSession()->SendAreaTriggerMessage("无法在竞技场或者战场使用冷却结晿");
            return false;
        }
        ...
        {
            pPlayer->GetSession()->SendAreaTriggerMessage("无法在潜行时使用");
            return false;
        }
        ...
        if (pPlayer->duel)
        {
            pPlayer->GetSession()->SendAreaTriggerMessage("无法在决斗时使用");
            return false;
        }
        // Check if VIP, One-Character-VIP or GM rights present on this account/character
        if (pPlayer->HasItemCount(ONE_CHARACTER_VIP, 1))
            pPlayer->ADD_GOSSIP_ITEM(4, "|TInterface/ICONS/Achievement_Zone_Ironforge:35:35|t|cffffff00Menu 只对VIP用户", GOSSIP_SENDER_MAIN, 0);
        ...
        case ALLIANCE:
            ...
            pPlayer->ADD_GOSSIP_ITEM_EXTENDED(4, "|TInterface/ICONS/Spell_Arcane_Portalstormwind:35:35|t|cff0000ff暴风城", GOSSIP_SENDER_MAIN, 2, "你确定去<暴风城>吗", 0, false);
        ...
        case HORDE:
            // pPlayer->ADD_GOSSIP_ITEM_EXTENDED(4, "|TInterface/ICONS/Achievement_Zone_Netherstorm_01:35:35|t|cff0000ffNeutral Mall", GOSSIP_SENDER_MAIN, 1337, "Are you sure you want to go to Neutral Mall?", 0, false);
            // pPlayer->ADD_GOSSIP_ITEM_EXTENDED(4, "|TInterface/ICONS/INV_MISC_GEM_AMETHYST_03:35:35|t|cff0000ffProfessions Place", GOSSIP_SENDER_MAIN, 5, "Are you sure you want to go to Professions Mall?", 0, false);
            pPlayer->ADD_GOSSIP_ITEM_EXTENDED(4, "|TInterface/ICONS/Spell_Arcane_PortalOrgrimmar:35:35|t|cff0000ff奥格瑞玛", GOSSIP_SENDER_MAIN, 4, "你确定去<奥格瑞玛>吗", 0, false);
            // pPlayer->ADD_GOSSIP_ITEM_EXTENDED(4, "|TInterface/ICONS/ACHIEVEMENT_WIN_WINTERGRASP:35:35|t|cff0000ffTransmogrification Place", GOSSIP_SENDER_MAIN, 18, "Are you sure you want to go to Transmogrification Place?", 0, false);
        ...
        // neutral zone
        pPlayer->ADD_GOSSIP_ITEM_EXTENDED(4, "|TInterface/ICONS/ACHIEVEMENT_ARENA_2V2_1:35:35|t|cff0000ff决斗区域", GOSSIP_SENDER_MAIN, 45, "你确定去<决斗区域>吗", 0, false);
        ...
        if (pPlayer->getClass() == CLASS_HUNTER)
            pPlayer->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/ABILITY_HUNTER_MASTERSCALL:35:35|t|cff0000ff猎人驯养宠物区", GOSSIP_SENDER_MAIN, 19, "你确定去<猎人驯养宠物区>吗", 0, false);
        else if (pPlayer->getClass() != CLASS_HUNTER)
			pPlayer->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/ABILITY_DRUID_DEMORALIZINGROAR:35:35|t|cff0000ff猎人驯养宠物区", GOSSIP_SENDER_MAIN, 42, "你确定去<猎人驯养宠物区>吗", 0, false);
        pPlayer->ADD_GOSSIP_ITEM(4, "|TInterface/ICONS/Ability_Mage_NetherWindPresence:35:35|t|cff0000ff附加功能", GOSSIP_SENDER_MAIN, 20);
    ...
    bool OnGossipSelect(Player * pPlayer, Creature * pCreature, uint32 sender, uint32 uiAction)
    {
        ...
        {
        case 0: // VIP mall
            pPlayer->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Zone_Ironforge:35:35|t|cffffff00传送到VIP商场", GOSSIP_SENDER_MAIN, 13, "你确定去<VIP商场>吗", 0, false);
            pPlayer->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Zone_Tanaris_01:35:35|t|cffffff00传送到VIP岛", GOSSIP_SENDER_MAIN, 14, "你确定去<VIP岛>吗", 0, false);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface/ICONS/ACHIEVEMENT_GUILDPERK_FASTTRACK:35:35|t|cffff0000上一页", GOSSIP_SENDER_MAIN, 15);
            pPlayer->SEND_GOSSIP_MENU(60020, pCreature->GetGUID());
            break;
        ...
        case 8: // Random queue places as group
            ...
            {
                pPlayer->GetSession()->SendAreaTriggerMessage("你不在队伍里!");
                pPlayer->CLOSE_GOSSIP_MENU();
                return false;
            }
        ...
        case 33: // ICC Dungeons - Coming Soon
            pPlayer->GetSession()->SendAreaTriggerMessage("ICC副本也将很快上线");
            pPlayer->CLOSE_GOSSIP_MENU();
            break;
        ...
        case 19: // Hunter's Tame Pet Zone
            ...
            pPlayer->GetSession()->SendAreaTriggerMessage("只有猎人可以在传送点菜单看猎人驯养宠物区");
            break;
        ...
        case 20: // Buffs
            ...
            pPlayer->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_General_StayClassy:35:35|t|cff0000ff重置我的天赋", GOSSIP_SENDER_MAIN, 31, "你确定重置你的天赋吗?", 0, false);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface/ICONS/Ability_Mage_NetherWindPresence:35:35|t|cffff0000上一页", GOSSIP_SENDER_MAIN, 15);
            pPlayer->SEND_GOSSIP_MENU(60022, pCreature->GetGUID());
            break;

        case 21: // Native morphs
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Tauren_Male:35:35|t|cff0000ff牛头人女", GOSSIP_SENDER_MAIN, 23);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Tauren_Female:35:35|t|cff0000ff牛头人男", GOSSIP_SENDER_MAIN, 24);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Gnome_Female:35:35|t|cff0000ff侏儒女", GOSSIP_SENDER_MAIN, 25);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Gnome_Male:35:35|t|cff0000ff侏儒男", GOSSIP_SENDER_MAIN, 26);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Bloodelf_Female:35:35|t|cff0000ff血精灵女", GOSSIP_SENDER_MAIN, 27);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Bloodelf_Male:35:35|t|cff0000ff血精灵男", GOSSIP_SENDER_MAIN, 28);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Human_Female:35:35|t|cff0000ff人类女", GOSSIP_SENDER_MAIN, 29);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "|TInterface/ICONS/Achievement_Character_Human_Male:35:35|t|cff0000ff人类男", GOSSIP_SENDER_MAIN, 30);
            pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "|TInterface/ICONS/ACHIEVEMENT_GUILDPERK_FASTTRACK:35:35|t|cffff0000上一页", GOSSIP_SENDER_MAIN, 20);
        ...
        case 31: // Reset talents
            ...
            pPlayer->GetSession()->SendAreaTriggerMessage("你的天赋已经重置");
            pPlayer->CastSpell(pPlayer, 24222, true);
            pPlayer->CLOSE_GOSSIP_MENU();
            break;
        ...
        case 40: // Already in zone
            pPlayer->GetSession()->SendAreaTriggerMessage("你已经在这个区域");
            pPlayer->CLOSE_GOSSIP_MENU();
            break;

        case 41: // Already in Dueling zone / Mall
            pPlayer->GetSession()->SendAreaTriggerMessage("你已经在决斗区！就在外面");
            pPlayer->CLOSE_GOSSIP_MENU();
            break;

        case 42: // you're not a hunter
            pPlayer->GetSession()->SendAreaTriggerMessage("你不是猎人");
            pPlayer->CLOSE_GOSSIP_MENU();
            break;
        ...
        case 49: // Raid for Orgrimmar
        {
            ...
            for (GroupReference* itr = group->GetFirstMember(); itr != NULL; itr = itr->next())
            {
                ...
                msg += "|cfffaeb00The 联盟袭击奥格瑞玛！保卫奥格瑞玛！";
        ...
        case 50: // Raid for Stormwind
        {
            ...
            for (GroupReference* itr = group->GetFirstMember(); itr != NULL; itr = itr->next())
            {
                ...
                std::string msg = "";
                msg += "|cffff6060[CITY WAR] ";
                msg += "|cfffaeb00The 部落袭击暴风城！保卫暴风城！";
