...
public:
    ...
    void CreatePet(Player *player, Creature * m_creature, uint32 entry) 
    {
        ...
        {
            m_creature->Whisper("你不是一个猎人!", LANG_UNIVERSAL, player);
    ...
    bool OnGossipHello(Player * player, Creature * m_creature)
    {
        ...
        player->ADD_GOSSIP_ITEM(4, "新的宠物.", GOSSIP_SENDER_MAIN, 30);
        if (player->CanTameExoticPets())
        {
            player->ADD_GOSSIP_ITEM(4, "新的特殊宠物.", GOSSIP_SENDER_MAIN, 50);
        }
        player->ADD_GOSSIP_ITEM(4, "宠物箱.", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_STABLEPET);
        player->ADD_GOSSIP_ITEM(4, "取消", GOSSIP_SENDER_MAIN, 150);
    ...
    bool OnGossipSelect(Player * player, Creature * m_creature, uint32 sender, uint32 action)
    {
        ...
        case 30:
            player->ADD_GOSSIP_ITEM(2, "回到主目录!", GOSSIP_SENDER_MAIN, 100);
            player->ADD_GOSSIP_ITEM(2, "下一页!", GOSSIP_SENDER_MAIN, 31);
            player->ADD_GOSSIP_ITEM(4, "蝙蝠.", GOSSIP_SENDER_MAIN, 18);
            player->ADD_GOSSIP_ITEM(4, "熊.", GOSSIP_SENDER_MAIN, 1);
            player->ADD_GOSSIP_ITEM(4, "野猪.", GOSSIP_SENDER_MAIN, 2);
            player->ADD_GOSSIP_ITEM(4, "猫.", GOSSIP_SENDER_MAIN, 4);
            player->ADD_GOSSIP_ITEM(4, "腐肉的鸟.", GOSSIP_SENDER_MAIN, 5);
            player->ADD_GOSSIP_ITEM(4, "螃蟹.", GOSSIP_SENDER_MAIN, 6);
            player->ADD_GOSSIP_ITEM(4, "鳄鱼.", GOSSIP_SENDER_MAIN, 7);
            player->ADD_GOSSIP_ITEM(4, "龙鹰.", GOSSIP_SENDER_MAIN, 17);
            player->ADD_GOSSIP_ITEM(4, "大猩猩.", GOSSIP_SENDER_MAIN, 8);
            player->ADD_GOSSIP_ITEM(4, "猎犬.", GOSSIP_SENDER_MAIN, 9);
            player->ADD_GOSSIP_ITEM(4, "土狼.", GOSSIP_SENDER_MAIN, 10);
            player->ADD_GOSSIP_ITEM(4, "飞蛾.", GOSSIP_SENDER_MAIN, 11);
            player->ADD_GOSSIP_ITEM(4, "猫头鹰.", GOSSIP_SENDER_MAIN, 12);
            player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, m_creature->GetGUID());
            break;

        case 31:
            player->ADD_GOSSIP_ITEM(2, "回到主目录!", GOSSIP_SENDER_MAIN, 100);
            player->ADD_GOSSIP_ITEM(2, "上一页!", GOSSIP_SENDER_MAIN, 30);
            player->ADD_GOSSIP_ITEM(4, "迅猛龙.", GOSSIP_SENDER_MAIN, 20);
            player->ADD_GOSSIP_ITEM(4, "掠食者.", GOSSIP_SENDER_MAIN, 19);
            player->ADD_GOSSIP_ITEM(4, "陆行鸟.", GOSSIP_SENDER_MAIN, 13);
            player->ADD_GOSSIP_ITEM(4, "蝎.", GOSSIP_SENDER_MAIN, 414);
            player->ADD_GOSSIP_ITEM(4, "蜘蛛.", GOSSIP_SENDER_MAIN, 16);
            player->ADD_GOSSIP_ITEM(4, "蛇.", GOSSIP_SENDER_MAIN, 21);
            player->ADD_GOSSIP_ITEM(4, "海龟.", GOSSIP_SENDER_MAIN, 15);
            player->ADD_GOSSIP_ITEM(4, "黄蜂.", GOSSIP_SENDER_MAIN, 93);
            player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, m_creature->GetGUID());
            break;
