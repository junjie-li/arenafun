...
INSERT INTO `template_npc_alliance` (`playerClass`, `playerSpec`, `pos`, `itemEntry`, `enchant`, `socket1`, `socket2`, `socket3`, `bonusEnchant`, `prismaticEnchant`) VALUES
	...
	('Paladin', 'Holy', 4, 40908, 3832, 3520, 3865, 0, 3600, 0),
	...
	('DeathKnight', 'Unholy', 0, 40831, 3795, 3621, 3518, 0, 2787, 0),
	('DeathKnight', 'Unholy', 1, 42041, 0, 0, 0, 0, 0, 0),
	('DeathKnight', 'Unholy', 2, 40872, 3852, 3518, 0, 0, 0, 0),
	('DeathKnight', 'Unholy', 4, 40792, 3832, 3518, 3518, 0, 0, 0),
	('DeathKnight', 'Unholy', 5, 40883, 0, 3518, 3879, 0, 0, 3729),
	('DeathKnight', 'Unholy', 6, 40852, 3823, 3518, 3535, 0, 3357, 0),
	('DeathKnight', 'Unholy', 7, 40884, 1597, 3518, 0, 0, 0, 0),
	('DeathKnight', 'Unholy', 8, 40890, 3845, 0, 0, 0, 0, 0),
	('DeathKnight', 'Unholy', 9, 40810, 1603, 3518, 0, 0, 0, 0),
	...
	('Warrior', 'Protection', 2, 40829, 3793, 3550, 0, 0, 3263, 0),
	...
	('Warrior', 'Arms', 2, 40829, 3793, 3550, 0, 0, 3263, 0),
	...
	('Warrior', 'Fury', 2, 40829, 3793, 3550, 0, 0, 3263, 0),
	...
	('Hunter', 'Marksmanship', 16, 42210, 3731, 3519, 0, 0, 0, 0),
	('Hunter', 'Marksmanship', 17, 42487, 3608, 0, 0, 0, 0, 0),
	('DeathKnight', 'Frost', 0, 40831, 3795, 3621, 3518, 0, 2787, 0),
	('DeathKnight', 'Frost', 1, 42041, 0, 0, 0, 0, 0, 0),
	('DeathKnight', 'Frost', 2, 40872, 3852, 3518, 0, 0, 0, 0),
	('DeathKnight', 'Frost', 4, 40792, 3832, 3518, 3518, 0, 0, 0),
	...
	('DeathKnight', 'Frost', 9, 40810, 1603, 3518, 0, 0, 0, 0),
